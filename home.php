...
if (isset($_COOKIE["user"])){
    $poruka="Dobrodošao/la, " . $_COOKIE["user"] . "!";
}
?> 
...
<body>
    ...
    <div class="container-xxl py-5">
        ...
        <center><h3 id="poruka"><?= $poruka; ?></h3></center>
            ...
            <center>
            <a href="dodaj.php", class="BtnForm">Dodaj rezervaciju</a>
            <a href="izmeni.php", class="BtnForm">Izmeni rezervaciju</a>
            <a href="obrisi.php", class="BtnForm">Otkaži rezervaciju</a>
            </center>
